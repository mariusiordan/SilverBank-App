...
export default function CashTracker({ userId }: { userId: number }) {
  ...
  return (
    <section style={{
      ...
      <h3 style={{ fontSize: "1.3rem", fontWeight: 700, marginBottom: "1.5rem", color: "#222" }}>
        💵 Cash Tracker
      </h3>
      ...
      <form onSubmit={handleAdd} style={{
        display: "grid",
        gridTemplateColumns: "1fr 140px 180px 100px",
        gap: "0.75rem",
        marginBottom: "1.5rem",
      }}>
        <input
          style={{ padding: "0.6rem 1rem", borderRadius: 8, border: "1px solid #ddd", fontSize: "0.95rem" }}
        ...
        />
        <select
          style={{ padding: "0.6rem 1rem", borderRadius: 8, border: "1px solid #ddd", fontSize: "0.95rem", background: "#fff" }}
          value={category}
        ...
        <button
          ...
          style={{
            ...
            background: "#2ecc71", color: "#fff", fontWeight: 700,
      ...
      {entries.length === 0 ? (
        ...
        <>
          <div style={{
            ...
            background: "#f8f9fa", borderRadius: 8, fontWeight: 600, color: "#333"
          }}>
          ...
          {entries.map(e => (
            <div key={e.id} style={{
              ...
              background: "#f8f9fa", borderLeft: "4px solid #2ecc71",
            }}>
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                <span style={{
                  background: "#e8f8f0", color: "#27ae60",
                  borderRadius: 6, padding: "0.2rem 0.6rem", fontSize: "0.8rem", fontWeight: 600,
                }}>
                  {e.category}
                </span>
